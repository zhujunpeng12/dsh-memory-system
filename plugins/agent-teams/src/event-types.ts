...
/** Records one demand-brief submission by the captain. */
export interface AgentTeamsBriefSubmittedData {
  readonly teamId: string
  readonly status: string
}
...
declare module '@deepseek-ai/dsh-session/types' {
  interface SessionEventMap {
    ...
    /**
     * Records one demand-brief submission.
     * @param data - team identity and the brief status.
     */
    'agent-teams/brief-submitted': AgentTeamsBriefSubmittedData
  }
}
